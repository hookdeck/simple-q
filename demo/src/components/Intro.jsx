  ...
  return (
    <>
      ...
      <h1 className="mt-14 font-display text-4xl/tight font-light text-white">
        Open-source queuing system <span className="text-sky-300">for minimalists</span>
      </h1>
      <p className="mt-4 text-sm/6 text-gray-300">
        SimpleQ is the ultimate tool for developers who require an asynchronous message queue. With just two lines of
        code, you can create a complete queue.
      </p>
      <NPMInstall />
      <div className="mt-8 flex flex-wrap justify-center gap-x-1 gap-y-3 sm:gap-x-2 lg:justify-start">
        <IconLink href="https://github.com/hookdeck/simple-q" icon={GitHubIcon} className="flex-none">
          GitHub
        </IconLink>
      </div>
    </>
...
export function IntroFooter() {
  return (
    <p className="flex items-baseline gap-x-2 text-[0.8125rem]/6 text-gray-500">
      Brought to you by{" "}
      <IconLink href="https://twitter.com/mkherlakian" icon={TwitterIcon} compact large>
        HCK23
      </IconLink>
    </p>
  );
