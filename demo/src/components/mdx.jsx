  ...
  return (
    <div className="mx-auto max-w-7xl px-6 lg:flex lg:px-8">
      <div className="lg:ml-96 lg:flex lg:w-full lg:justify-end lg:pl-32">
        <div className={clsx("mx-auto max-w-lg lg:mx-0 lg:w-0 lg:max-w-xl lg:flex-auto", className)}>{children}</div>
      </div>
    </div>
  );
}
...
//         <div className="flex">
//           <Link href={`#${id}`} className="inline-flex">
//             <FormattedDate date={date} className="text-2xs/4 font-medium text-gray-500 dark:text-white/50 xl:hidden" />
//           </Link>
//         </div>
//       </ContentWrapper>
//     </header>
